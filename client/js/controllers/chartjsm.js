 ...
 */
var chartJsmCtrl = function (datosmFactory,$stateParams,$state){
    ...
    datosmFactory.gettingLabels($stateParams.month || "")
		.success(function (labels) {
			vm.labels = labels;
			console.log("labels:" + vm.labels);
			datosmFactory.gettingData($stateParams.month || "")
...
angular
    .module('mebsc')
    .controller('chartJsmCtrl', chartJsmCtrl)
