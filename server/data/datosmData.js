...
exports.updatingById = function (_id, dato) {
    delete dato.any;
   	delete dato.mes;
   	delete dato._id;
   	dato.impagos = parseInt(dato.impagos);
   	dato.ingresoVenta = parseInt(dato.ingresoVenta);
	dato.gastoCompra = parseInt(dato.gastoCompra);
	dato.gastoPersonal = parseInt(dato.gastoPersonal);
	dato.gastoExplotacion = parseInt(dato.gastoExplotacion);
